  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 mt-8 sm:mt-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
        {/* Featured Card */}
        <div className="bg-[#0C97D5] text-white rounded-xl p-6 sm:p-8 flex flex-col justify-between min-h-[240px] sm:min-h-[256px] shadow-sm">
          ...
          <div className="mt-6 sm:mt-8">
            <h2 className="text-xl sm:text-2xl lg:text-[28px] xl:text-[32px] font-medium leading-tight mb-2">
              Product Development and sampling
            </h2>
            <p className="text-sm sm:text-base lg:text-[18px] opacity-90 leading-relaxed">
        ...
        {services.map((item, index) => (
          <div
            key={index}
            className="bg-white border border-gray-200 rounded-xl p-6 sm:p-8 flex flex-col justify-between min-h-[240px] sm:min-h-[256px] hover:border-blue-400 hover:shadow-md transition-all duration-300"
          >
            <div className="w-10 h-10 shrink-0">
              <img
                src={item.image}
            ...
            <div className="mt-6 sm:mt-8">
              <h2 className="text-xl sm:text-2xl lg:text-[28px] xl:text-[32px] font-medium text-gray-900 leading-tight mb-2">
                {item.title}
              </h2>
              <p className="text-sm sm:text-base lg:text-[18px] text-gray-600 leading-relaxed">
                {item.description}
              </p>
            </div>
          </div>
